...
onMounted(async () => {
    try {
        ...
        const resume = await puterStore.getKV(`resume:${id}`);
    ...
    <v-app>
        <v-app-bar :elevation="0">
            <v-container class="d-flex align-center justify-space-between w-100">
                ...
                <a class="text-black text-h5 font-weight-bold text-decoration-none" href="/">
                    resumatch.ai
                </a>
            </v-container>
        </v-app-bar>
                ...
                <v-col cols="12" md="6">
                    <div class="bg-white pa-4 h-100">
                        <a :href="resumeUrl || '#'" target="_blank">
                            <img :src="imageUrl || resumePreview" class="w-100 h-100" title="resume"
                ...
                <v-col cols="12" md="6">
                    <div class="d-flex flex-column ga-6 bg-white pa-8 h-100">
                        ...
                        <div class="d-flex ga-4">
                            <v-progress-circular :model-value="feedback.overallScore"
                                :color="getScoreColor(feedback.overallScore)"
                                :bg-color="`${getScoreColor(feedback.overallScore)}-lighten-4`" size="60" width="8"
                                rounded>
                                <span class="text-black">{{ feedback.overallScore }}%</span>
                            </v-progress-circular>
                            <div class="d-flex flex-column ga-1">
                                <p class="text-h5 font-weight-bold">Your Resume Score</p>
                                <span class="text-grey">This score is calculated based on the variables listed
                                    below.</span>
                            </div>
                        </div>
                        ...
                        <div class="d-flex flex-column ga-4">
                            <div class="border" v-for="(section, key) in feedback.sections" :key="key">
                                <v-container class="d-flex justify-space-between">
                                    <div class="d-flex align-center ga-2">
                                        <p class="text-h5 text-capitalize">{{ String(key).replace('_', ' & ') }}</p>
                                        <span
                                    ...
                                    <p class="text-h5">
                                        <strong :class="`text-${getScoreColor(section.score)}`">{{ section.score
                                            }}</strong>/100
                                    </p>
                                </v-container>
                            </div>
                        ...
                        <div
                            ...
                            <p class="text-h5 font-weight-bold">
                                ✅ ATS Score - <strong :class="`text-${getScoreColor(feedback.ATS.score)}`">{{
                                    feedback.ATS.score }}</strong>/100
                            </p>
                            <p class="font-weight-bold text-h7">How well does your resume pass through Applicant
                                Tracking Systems?</p>

                            <div v-for="tip in feedback.ATS.tips" :key="tip" class="d-flex align-center ga-2">
                                <v-icon :color="getTypeColor(tip.type)">{{ getTypeIcon(tip.type) }}</v-icon>
                        ...
                        <v-expansion-panels :elevation="0">
                            ...
                            <v-expansion-panel>
                                <v-expansion-panel-title>
                                    <span class="font-weight-bold text-h6 text-capitalize">Tone & Style</span>
                                    <span
                                ...
                                <v-expansion-panel-text>
                                    <div class="d-flex flex-column ga-2">
                                        ...
                                        <v-list v-for="suggestion in feedback.toneAndStyle.tips" :key="suggestion">
                                            <div
                            ...
                            <v-expansion-panel>
                                <v-expansion-panel-title>
                                    <span class="font-weight-bold text-h6 text-capitalize">Content</span>
                                    <span
                                ...
                                <v-expansion-panel-text>
                                    <div class="d-flex flex-column ga-2">
                                        ...
                                        <v-list v-for="suggestion in feedback.content.tips" :key="suggestion">
                                            <div
                                                :class="`bg-${getTypeColor(suggestion.type)}-lighten-5 pa-4 rounded-lg text-${getTypeColor(suggestion.type)}-darken-1`">
                                                <div class="d-flex aligns-center ga-2 font-weight-bold">
                                                    <v-icon :color="getTypeColor(suggestion.type)">{{
                            ...
                            <v-expansion-panel>
                                <v-expansion-panel-title>
                                    <span class="font-weight-bold text-h6 text-capitalize">Strucure</span>
                                    <span
                                ...
                                <v-expansion-panel-text>
                                    <div class="d-flex flex-column ga-2">
                                        ...
                                        <v-list v-for="suggestion in feedback.structure.tips" :key="suggestion">
                                            <div
                                                :class="`bg-${getTypeColor(suggestion.type)}-lighten-5 pa-4 rounded-lg text-${getTypeColor(suggestion.type)}-darken-1`">
                                                <div class="d-flex aligns-center ga-2 font-weight-bold">
                                                    <v-icon :color="getTypeColor(suggestion.type)">{{
                            ...
                            <v-expansion-panel>
                                <v-expansion-panel-title>
                                    <span class="font-weight-bold text-h6 text-capitalize">Skills</span>
                                    <span
                                ...
                                <v-expansion-panel-text>
                                    <div class="d-flex flex-column ga-2">
                                        ...
                                        <v-list v-for="suggestion in feedback.skills.tips" :key="suggestion">
                                            <div
                                                :class="`bg-${getTypeColor(suggestion.type)}-lighten-5 pa-4 rounded-lg text-${getTypeColor(suggestion.type)}-darken-1`">
                                                <div class="d-flex aligns-center ga-2 font-weight-bold">
                                                    <v-icon :color="getTypeColor(suggestion.type)">{{
